  ...
  async function checkBorrowerInfo(borrowerID) {
    try {
      ...
      const data = await fetch(
        "https://api-decimal.lmscarbon.com/carbon-product-service/lmscarbon/api/v1/borrowers/" +
          borrowerID,
        {
          method: "GET",
          headers: {
...
const SearchBox = () => {
    ...
    async function checkBorrowerInfoUser(borrowerID) {
        try {
            const token = localStorage.getItem("authToken");
            const data = await fetch(
                "https://api-decimal.lmscarbon.com/carbon-registration-service/lmscarbon/api/v1/borrowers/" +
                borrowerID +
    ...
    async function createNewRac(Name) {
        try {
            ...
            const response = await fetch(
                "https://api-decimal.lmscarbon.com/carbon-product-service/lmscarbon/rules/rac/" + Name,
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
