...
const LoanInfoModal = ({ visible, onClose, loanDetails, mgLeft }) => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white border border-red-600 p-8 rounded-xl overflow-y-auto overflow-x-hidden w-3/4 h-[600px] relative shadow-lg transition-all duration-500 ease-in-out">
          <div className="font-semibold text-center text-xl text-gray-700 mb-5">
            Loan Information
          </div>
          <div className="grid grid-cols-2 gap-10 text-left border-b border-gray-300 pb-5">
