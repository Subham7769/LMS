    ...
    <>
      <div>
        <ContainerTile className="flex items-center gap-5 mb-5">
          <img className="rounded-full w-12" src="https://lmscarbon.com/assets/index.png" alt="" />
        ...
        <ContainerTile>
          ...
          <div className="grid grid-cols-2 gap-4 border-b border-gray-300 mb-10 text-[14px] pb-2">
            <InfoRow label="Full Name" value={`${borrowerProfile.firstNameEn} ${borrowerProfile.middleNameEn} ${borrowerProfile.lastNameEn}`} />
            ...
            <InfoRow label="Monthly Expenses" value={borrowerProfile.totalMonthlyExpenses} />
          ...
          <div className="grid grid-cols-2 gap-4 border-b border-gray-300 mb-10 text-[14px] pb-2">
            ...
            <InfoRow label="No of Domestic Workers" value={maritalDetails.noOfDomesticWorkers} />
            <InfoRow label="Total Dependent" value={maritalDetails.totalDependent} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 border-b border-gray-300 mb-5 text-[14px] pb-2">
            <InfoRow label="Address" value={`${residenceDetails.buildingNumber}, ${residenceDetails.streetName}, ${residenceDetails.city}`} />
            ...
            <InfoRow label="Additional Number" value={residenceDetails.additionalNumbers} />
            <InfoRow label="Neighborhood" value={residenceDetails.neighborhood} />
            <InfoRow label="City" value={residenceDetails.city} />
            <InfoRow label="Building Number" value={residenceDetails.buildingNumber} />
