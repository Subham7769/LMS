...
class ElementErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    console.log("Error caught in ElementErrorBoundary:", error, errorInfo);
  }
    ...
    if (error.message.includes('Network')) {
      return (
        <div className={classStyle}>
          ...
          <p className="text-[14px] text-blue-500">Network error occurred. Please check your connection.</p>
        </div>
      );
      ...
      return (
        <div className={classStyle}>
          ...
          <p className="text-[14px] text-yellow-500">API error occurred. Please try again later.</p>
        </div>
      );
      ...
      return (
        <div className={classStyle}>
          ...
          <p className="text-[14px] text-indigo-500">Validation error occurred. Please check your input.</p>
        </div>
      );
      ...
      return (
        <div className={classStyle}>
          ...
          <p className="text-[14px] text-green-500">Element type is invalid. Please check your JSX.</p>
        </div>
      );
    } else {
      return (
        <div className={classStyle}>
          ...
          <p className="text-[14px] text-red-500">An unexpected error occurred: {this.state.error.message}</p>
        </div>
      );
    }
  }
