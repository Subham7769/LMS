...
const RouteErrorBoundary = () => {
  ...
  return (
    <>
      <div className={"flex justify-center items-center flex-col gap-3 bg-gray-100 min-h-[70vh] p-8 h-fit w-[100%]"}>
      <div className="bg-white w-[90%] h-[80%] p-8 rounded-xl shadow-lg text-center">
          ...
          {roleName === "ROLE_SUPERADMIN" && (<details className="flex justify-center items-center w-[100%]">
