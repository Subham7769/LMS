...
const Login = () => {
  ...
  return (
    <div className="bg-[url('https://colorlib.com/etc/lf/Login_v5/images/bg-01.jpg')] bg-no-repeat bg-center bg-cover h-lvh flex items-center">
      <div className="border border-red-600 rounded p-4 mx-auto w-3/12  bg-white">
