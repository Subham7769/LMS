...
const KeyStatements = ({
  ...
  return (
    <div className="flex flex-col justify-center align-middle gap-5 m-10">
      ...
      {/* Section 1 Key Term */}
      <table className="w-full border border-border-gray-primary border-collapse">
        <tbody>
          <tr className="border border-border-gray-primary">
            <td
              colSpan={6}
              className="border border-border-gray-primary p-2 text-center font-semibold"
            >
              SECTION I: KEY TERMS
            </td>
          </tr>
          <tr className="border border-border-gray-primary text-center font-semibold">
            <td colSpan={2} className="border border-border-gray-primary p-2">
              LOAN SUMMARY
            </td>
            <td colSpan={2} className="border border-border-gray-primary p-2">
              COST OF CREDIT
          ...
          <tr className="border border-border-gray-primary">
            <td rowSpan={2} className="border border-border-gray-primary p-2">
              <div className="font-semibold">1. Amount of Loan</div>
              <div className="italic text-sm">Amount you are borrowing</div>
            </td>
            <td
              rowSpan={2}
              className="border border-border-gray-primary p-2 font-semibold text-center"
            >
              <div>(ZMW)</div>
            ...
            <td className="border border-border-gray-primary p-2 font-semibold">
          ...
          <tr className="border border-border-gray-primary">
            ...
            <td className="border border-border-gray-primary p-2">
              <div className="font-semibold">5. Other Fees and Charges</div>
              <div className="italic text-sm">See details in Section IV</div>
            </td>
            <td className="border border-border-gray-primary p-2 font-semibold text-center">
              <div>(ZMW)</div>
      ...
      <div className="grid grid-cols-8">
        <div className="col-span-2 border border-border-gray-primary p-2 grid gap-y-2">
          <div className="font-semibold">1. Amount of Loan</div>
          <div className="italic text-sm">Amount you are borrowing</div>
      ...
      {/* Section 2 Risks */}
      <div className="mt-5 font-semibold text-center border border-border-gray-primary p-1">
      ...
      <table className="mt-5 w-full border border-border-gray-primary border-collapse">
        <tr className="border border-border-gray-primary">
          <td
            colSpan={6}
            className="border border-border-gray-primary p-2 text-center font-semibold"
        ...
        <tr className="border border-border-gray-primary">
          ...
          <td className="border border-border-gray-primary p-2 text-center font-semibold">
      ...
      <table className="mt-5 w-full border border-border-gray-primary border-collapse">
        ...
        <tr className="border border-border-gray-primary text-center font-semibold">
          ...
          <td className="border border-border-gray-primary p-2">Principal</td>
          <td className="border border-border-gray-primary p-2">
        ...
        {repayment?.repaymentSchedule?.map((repayment, index) => (
          <tr
            key={index + 1}
            className="border border-border-gray-primary text-center"
          >
            <td className="border border-border-gray-primary p-2">
              {index + 1}
            </td>
        ...
        <tr className="border border-border-gray-primary text-center ">
          <td className="border border-border-gray-primary p-2 font-semibold">
            TOTAL
          </td>
          <td className="border border-border-gray-primary p-2"></td>
          <td className="border border-border-gray-primary p-2">
