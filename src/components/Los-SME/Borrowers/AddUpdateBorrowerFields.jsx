...
import { countryOptions, locationOptions,natureOfCompanyOptions } from "../../../data/CountryData";
import {
  maritalStatus,
  workType,
  title,
...
const AddUpdateBorrowerFields = ({ BorrowerData, handleChangeReducer }) => {
  ...
  const companyDetailsConfig = [
    ...
    {
      labelName: "Company Name (Short Form)",
      inputName: "companyShortName",
      type: "text",
      validation: false,
    },
    {
      labelName: "Nature of Company (Limited or Business Name)",
    ...
    {
      labelName: "Date of Incorporation/Registration",
