...
export const districtOptions = {
  Lusaka: [
    ...
    { value: "Chongwe Town", label: "Chongwe Town" },
    { value: "Kafue Town", label: "Kafue Town" },
    { value: "Luangwa Boma", label: "Luangwa Boma" },
  ],
  Copperbelt: [
    { value: "Kitwe City", label: "Kitwe City" },
    { value: "Ndola City", label: "Ndola City" },
    { value: "Chingola Town", label: "Chingola Town" },
    { value: "Mufulira Town", label: "Mufulira Town" },
    { value: "Luanshya Town", label: "Luanshya Town" },
  ],
  Southern: [
    { value: "Livingstone City", label: "Livingstone City" },
    { value: "Choma Town", label: "Choma Town" },
    { value: "Mazabuka Town", label: "Mazabuka Town" },
    { value: "Monze Town", label: "Monze Town" },
  ],
  Central: [
    { value: "Kabwe City", label: "Kabwe City" },
    { value: "Kapiri Mposhi Town", label: "Kapiri Mposhi Town" },
    { value: "Mkushi Town", label: "Mkushi Town" },
  ],
  Eastern: [
    { value: "Chipata City", label: "Chipata City" },
    { value: "Petauke Town", label: "Petauke Town" },
  ],
  Luapula: [{ value: "Mansa Town", label: "Mansa Town" }],
  Northern: [{ value: "Kasama Town", label: "Kasama Town" }],
  Muchinga: [{ value: "Mpika Town", label: "Mpika Town" }],
  "North-Western": [{ value: "Solwezi Town", label: "Solwezi Town" }],
  Western: [{ value: "Mongu Town", label: "Mongu Town" }],
};
