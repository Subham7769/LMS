    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="w-[90%] bg-white shadow-lg rounded-lg p-8 relative">
        ...
        <p className="text-lg text-gray-600 text-center mb-10">
          We're here to assist you. Choose one of the support options below or
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          {/* Email Support */}
          <div className="p-6 bg-background-light-secondary rounded-lg shadow-md hover:shadow-xl transition">
          ...
          <div className="p-6 bg-background-light-secondary rounded-lg shadow-md hover:shadow-xl transition">
            ...
            <button className="text-blue-600 hover:text-blue-800 mt-4 inline-block">
              Start a Chat
            </button>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <ul className="space-y-4">
            <li className="bg-background-light-secondary p-4 rounded-lg shadow-md">
            ...
            <li className="bg-background-light-secondary p-4 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mt-2">
                You can contact us via email, phone, or live chat using the
                options above.
              </p>
            </li>
            <li className="bg-background-light-secondary p-4 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mt-2">
                You can find your billing information in your account settings
